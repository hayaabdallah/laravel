         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control" style="height:150px" name="movie_description" placeholder="Description">{{ $movie->movie_description }}</textarea>
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>image:</strong>
                    <input type="file" name="photo" value="{{ $movie->photo }}" class="form-control" placeholder="image">
                </div>
            </div>
